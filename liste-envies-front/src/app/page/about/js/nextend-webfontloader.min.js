  ...
  (function () {
    ...
    function W(t) {
      return (
        ...
        y(t.c) +
        ";" +
        ("font-style:" + _(t) + ";font-weight:" + (t.f + "00") + ";")
      );
    }
          ...
          if (0 === e.length && s) T(n.a);
            ...
            for (f = 0; f < e.length; f++) {
              var l = e[f],
                ...
                g = l;
              if (
                (p.g && r(p.f, [p.a.c("wf", g.c, b(g).toString(), "loading")]),
                N(p, "fontloading", g),
                (p = null),
                null === ot)
              )
                if (window.FontFace) {
                  var g = /Gecko.*Firefox\/(\d+)/.exec(
                      window.navigator.userAgent
                    ),
                    d =
              ...
              (p = ot
                ? new F(i(n.g, n), i(n.h, n), n.c, l, n.s, u)
                : new I(i(n.g, n), i(n.h, n), n.c, l, n.s, t, u)),
                h.push(p);
            }
